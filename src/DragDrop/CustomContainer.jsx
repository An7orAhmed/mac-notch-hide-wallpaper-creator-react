    ...
    <>
      ...
      <div
        className={`${dragging
          ...
          } flex items-center justify-center mx-auto text-center border-2 rounded-md mt-4`}
        ref={dropContainer}
      >
        <div className="flex-1 flex flex-col py-10 hover:bg-slate-100 transition-all duration-300" onClick={() => fileRef.current.click()}>
